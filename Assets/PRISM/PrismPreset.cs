...
[System.Serializable]
	...
	public class PrismPreset : ScriptableObject {
		...
		[SerializeField]
		public float fogMidPoint = 50f;

		[SerializeField]
		public float fogEndPoint = 50f;
		...
		[SerializeField]
		public Color fogMidColor = Color.black;
		...
		[SerializeField]
		public PrismEffects.OcclusionSource occlusionSource = PrismEffects.OcclusionSource.DepthTexture;
		...
		[SerializeField]
		public float brightSoftness = 0.2f;
