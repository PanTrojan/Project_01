...
//GUIContent fogIntensityContent = new GUIContent("   >Fog Intensity", "Maximum thickness of the fog effect");
	...
	GUIContent fogColorEndContent = new GUIContent ("   >Fog End Color", "");
	GUIContent fogColorMidContent = new GUIContent ("   >Fog Mid Color", "Color of the fog furthest to the camera");
	...
	GUIContent fogMidPointContent = new GUIContent ("   >Fog Mid Point", "Distance away from the camera at which the mid color begins to blend in");
